...
import DepartmentStudentsView from "./DepartmentStudents/DepartmentStudentsView";
import StudentDetailsView from "./DepartmentStudents/StudentDetailsView";
import DepartmentPlacementsView from "./DepartmentPlacements/DepartmentPlacementsView";
import PlacementsDetailsView from "./DepartmentPlacements/PlacementsDetailsView";
import DepartmentResearchView from "./DepartmentResearch/DepartmentResearchView";
import CompanyDetailsView from "./DepartmentPlacements/CompanyDetailsView";
...
const DepartmentUI = ({
	...
	const { selectedCourse, selectedFaculty, selectedStudent, selectedBatch } = state;

	useEffect(() => {
		window.scrollTo(0, 0);
	}, [activeTab, selectedCourse, selectedFaculty, selectedStudent, selectedBatch]);
				...
				{error ? (
					...
					<div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
						...
						{activeTab === "placements" &&
							(selectedBatch ? (
								state.viewFilters.viewType === "companies" ? (
									<CompanyDetailsView
										onBack={() =>
											actions.setSelectedBatch({
												viewType: "placements",
											})
										}
									/>
								) : (
									<PlacementsDetailsView
								...
								<DepartmentPlacementsView
									onBatchClick={({ batchId, viewType }) => {
										actions.setSelectedBatch({
											batchId,
											viewType,
										});
						...
						{/* Research Tab */}
						{activeTab === "research" && <DepartmentResearchView />}
					</div>
				)}
			</main>
