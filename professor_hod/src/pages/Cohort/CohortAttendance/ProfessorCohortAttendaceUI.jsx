// src/pages/Cohort/CohortAttendance/ProfessorCohortAttendanceUI.jsx
...
const ProfessorCohortAttendanceUI = ({
	...
	const getStatusConfig = () => {
		...
		if (statusMessage?.includes("not been marked")) {
			return {
						...
						<aside className="w-full lg:w-80 flex-shrink-0">
							<div className="sticky top-8 space-y-6">
								...
								<button
									...
									className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-black uppercase tracking-wider shadow-md"
								>
									...
									<div className="p-6 border-b border-gray-100 dark:border-gray-700 flex flex-col xl:flex-row xl:items-center justify-between gap-4">
										<div className="flex items-center gap-4">
											<button
												...
												className="p-2 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white rounded-xl transition-colors border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700/50"
											>
										...
										<div className="flex flex-col sm:flex-row items-center gap-3">
											<div className="relative w-full sm:w-80">
												...
												<input
													...
													className="pl-11 pr-4 py-3 bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-700 rounded-xl text-sm w-full outline-none focus:ring-2 focus:ring-blue-500/20 transition-all font-medium"
												/>
											</div>
											<button
												onClick={onExport}
								...
								<div className="flex-grow flex flex-col items-center justify-center text-center gap-6 p-12">
									...
									{statusConfig.showAction && (
										<button
											onClick={() =>
												navigate(
													`/attendance-management/mark/${cohort?.id}`,
													{
														state: {
															date: selectedDate,
														},
											...
											className="flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-lg font-black uppercase text-xs tracking-wider"
										>
									...
									{isDraft && (
										<div className="bg-orange-50 dark:bg-orange-900/10 border-b border-orange-100 dark:border-orange-800/30 p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
											...
											<button
												...
												className="w-full md:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white text-xs font-black uppercase rounded-lg transition-colors"
											>
