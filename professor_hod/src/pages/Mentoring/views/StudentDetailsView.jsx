						...
						<div className="flex flex-col md:flex-row items-center gap-6 w-full md:w-auto">
							...
							<div className="flex flex-col items-center md:items-start text-center md:text-left">
								<div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
									...
									{/* Student Type Badge */}
									{studentType && (
										<span className="px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-sky-100 dark:bg-sky-900/30 text-sky-700 dark:text-sky-300 border border-sky-200 dark:border-sky-800">
											{studentType}
										</span>
									)}
								</div>
