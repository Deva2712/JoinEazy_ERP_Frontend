...
/**
 * Service for managing courses (cohorts), group assignments, and academic materials.
 */
export const courseService = {
	...
	// Update visibility and duration for grades
    updateGradeVisibility: (cohortId, assignmentId, visibilityData) => {
        /**
         * visibilityData expected format:
         * {
         *   isVisible: boolean,
         *   durationDays: number
         * }
         */
        const url = assignmentId === "all" 
            ? `/cohort/${cohortId}/assignments/visibility/bulk`
            : `/cohort/${cohortId}/assignments/${assignmentId}/visibility`;
