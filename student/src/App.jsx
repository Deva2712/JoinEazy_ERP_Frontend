...
import IndustryRelationsController from "./pages/IndustryRelations/IndustryRelationsController.jsx";
import CompanyDetailPage from "./pages/IndustryRelations/CompanyDetailPage.jsx";
import MouDetailPage from "./pages/IndustryRelations/MouDetailPage.jsx";
import PipelineDetailPage from "./pages/IndustryRelations/PipelineDetailPage.jsx";
import RiskGovernanceController from "./pages/RiskGovernance/RiskGovernanceController.jsx";
import AdvancedAnalyticsController from "./pages/AdvancedAnalytics/AdvancedAnalyticsController.jsx";
import FacultyLifecycleController from "./pages/FacultyLifecycle/FacultyLifecycleController.jsx";
import AccreditationController from "./pages/Accreditation/AccreditationController.jsx";
import ProgramGovernanceController from "./pages/ProgramGovernance/ProgramGovernanceController.jsx";
import CurriculumGovernanceController from "./pages/CurriculumGovernance/CurriculumGovernanceController.jsx";
import ResearchStrategyController from "./pages/ResearchStrategy/ResearchStrategyController.jsx";
import FinancialGovernanceController from "./pages/FinancialGovernance/FinancialGovernanceController.jsx";
	...
	return (
		...
		>
			<Routes>
				...
				>
					{/* Handles:
						1. /attendance-management/logs
						2. /attendance-management/:courseId
						3. /attendance-management/:courseId/qr
					*/}
					<Route
						path="logs"
						element={
				...
				<Route
					...
					element={
						<ProtectedRoute allowedRoles={["hod", "professor", "dean"]}>
				...
				<Route
					path="/industry-relations/:tab?"
					element={
						<ProtectedRoute allowedRoles={["dean"]}>
							<IndustryRelationsController userRole={userRole} />
						</ProtectedRoute>
					}
				/>

				{/* Industry Relations — Detail Pages */}
				<Route path="/industry-relations/company-detail" element={<ProtectedRoute allowedRoles={["dean"]}><CompanyDetailPage /></ProtectedRoute>} />
				<Route path="/industry-relations/mou-detail"     element={<ProtectedRoute allowedRoles={["dean"]}><MouDetailPage /></ProtectedRoute>} />
				<Route path="/industry-relations/pipeline-detail" element={<ProtectedRoute allowedRoles={["dean"]}><PipelineDetailPage /></ProtectedRoute>} />

				{/* Dean Module: Risk & Governance */}
				<Route
					path="/risk-governance/:tab?"
					element={
						<ProtectedRoute allowedRoles={["dean"]}>
							<RiskGovernanceController userRole={userRole} />
						</ProtectedRoute>
					}
				/>
				...
				<Route
					path="/advanced-analytics/:tab?"
					element={
						<ProtectedRoute allowedRoles={["dean"]}>
							<AdvancedAnalyticsController userRole={userRole} />
						</ProtectedRoute>
					}
				/>
				...
				<Route
					path="/faculty-lifecycle/:tab?"
					element={
						<ProtectedRoute allowedRoles={["dean"]}>
							<FacultyLifecycleController userRole={userRole} />
						</ProtectedRoute>
					}
				/>
				...
				<Route
					path="/accreditation/:tab?"
					element={
						<ProtectedRoute allowedRoles={["dean"]}>
							<AccreditationController userRole={userRole} />
						</ProtectedRoute>
					}
				/>
				...
				<Route
					path="/program-governance/:tab?"
					element={
						<ProtectedRoute allowedRoles={["dean"]}>
							<ProgramGovernanceController userRole={userRole} />
						</ProtectedRoute>
					}
				/>
				...
				<Route
					path="/curriculum-governance/:tab?"
					element={
						<ProtectedRoute allowedRoles={["dean"]}>
							<CurriculumGovernanceController userRole={userRole} />
						</ProtectedRoute>
					}
				/>
				...
				<Route
					path="/research-strategy/:tab?"
					element={
						<ProtectedRoute allowedRoles={["dean"]}>
							<ResearchStrategyController userRole={userRole} />
						</ProtectedRoute>
					}
				/>
				...
				<Route
					path="/financial-governance/:tab?"
					element={
						<ProtectedRoute allowedRoles={["dean"]}>
							<FinancialGovernanceController userRole={userRole} />
						</ProtectedRoute>
					}
				/>
