...
const DepartmentCourseCard = ({ course }) => {
	const isArchived = course.status === "Archived";

	return (
		<div
			className={`group bg-white dark:bg-[#1a1d26] p-5 rounded-2xl border flex flex-col h-full gap-4 transition-all duration-300 cursor-pointer hover:shadow-xl hover:shadow-violet-500/5 hover:-translate-y-1 ${
				isArchived
